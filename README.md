...
2. Configuration.
  ...
  `local_assembly/Configure.mak`. 
    ...
    2.4 Create a BAM fofn.  This should be a file of complete paths to
...
3. Run local assemblies.
 ...
 3.2 Define the regions that will be assembled. These can be copied
...
`hgsvg/phasing/DetermineInheritance.py  --vcf data/rgn1.vcf.gz --child HG00733 --fa HG00731 --mo HG00732 --faBed fa.bed --moBed mo.bed`
 ...
 generate grid commands for SGE and SLURM in
